...
start_message = test_font.render('Press space to play', False, (111, 196, 169))
start_rect = start_message.get_rect(center = (400, 350))
...
while True:
    ...
    if game_active:
        ...
        if score == 0: screen.blit(start_message, start_rect)
